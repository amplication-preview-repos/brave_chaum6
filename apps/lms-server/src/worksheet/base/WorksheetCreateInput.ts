...
class WorksheetCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => QuestionCreateNestedManyWithoutWorksheetsInput,
  })
  @ValidateNested()
  @Type(() => QuestionCreateNestedManyWithoutWorksheetsInput)
  @IsOptional()
  @Field(() => QuestionCreateNestedManyWithoutWorksheetsInput, {
    nullable: true,
  })
...
export { WorksheetCreateInput as WorksheetCreateInput };
