...
class WorksheetUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => QuestionUpdateManyWithoutWorksheetsInput,
  })
  @ValidateNested()
  @Type(() => QuestionUpdateManyWithoutWorksheetsInput)
  @IsOptional()
  @Field(() => QuestionUpdateManyWithoutWorksheetsInput, {
    nullable: true,
  })
...
export { WorksheetUpdateInput as WorksheetUpdateInput };
